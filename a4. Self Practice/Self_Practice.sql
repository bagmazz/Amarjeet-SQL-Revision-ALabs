...
select background , sum(term_1_marks) as total_marks from Student_Data group by background 
having background = 'medical'

-- having will be always used when there is we have to categorized by  aggregate functions. 
